...
part of 'auth_datasource_remote.dart';
...
class _AuthDatasourceRemote implements AuthDatasourceRemote {
  _AuthDatasourceRemote(this._dio, {this.baseUrl, this.errorLogger});
