...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( Success<T, E> value)?  success,TResult Function( Error<T, E> value)?  exception,required TResult orElse(),}){
final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that);case Error() when exception != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( Success<T, E> value)  success,required TResult Function( Error<T, E> value)  exception,}){
final _that = this;
switch (_that) {
case Success():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( Success<T, E> value)?  success,TResult? Function( Error<T, E> value)?  exception,}){
final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that);case Error() when exception != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T data)?  success,TResult Function( E error)?  exception,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that.data);case Error() when exception != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T data)  success,required TResult Function( E error)  exception,}) {final _that = this;
switch (_that) {
case Success():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T data)?  success,TResult? Function( E error)?  exception,}) {final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that.data);case Error() when exception != null:
return exception(_that.error);case _:
