...
/// Create a copy of CustomExceptions
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CustomExceptionsCopyWith<CustomExceptions> get copyWith => _$CustomExceptionsCopyWithImpl<CustomExceptions>(this as CustomExceptions, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CustomExceptions&&(identical(other.message, message) || other.message == message)&&(identical(other.stackTrace, stackTrace) || other.stackTrace == stackTrace));
}
...
@override
String toString() {
  return 'CustomExceptions(message: $message, stackTrace: $stackTrace)';
}
...
/// @nodoc
abstract mixin class $CustomExceptionsCopyWith<$Res>  {
  factory $CustomExceptionsCopyWith(CustomExceptions value, $Res Function(CustomExceptions) _then) = _$CustomExceptionsCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$CustomExceptionsCopyWithImpl<$Res>
    implements $CustomExceptionsCopyWith<$Res> {
  _$CustomExceptionsCopyWithImpl(this._self, this._then);

  final CustomExceptions _self;
  final $Res Function(CustomExceptions) _then;
...
/// Adds pattern-matching-related methods to [CustomExceptions].
extension CustomExceptionsPatterns on CustomExceptions {
...
return notFound(_that.message,_that.resource,_that.identitier,_that.stackTrace);case UnauthorizedException() when unauthorized != null:
...
return notFound(_that.message,_that.resource,_that.identitier,_that.stackTrace);case UnauthorizedException():
...
class ParsingException implements CustomExceptions {
...
@override
String toString() {
  return 'CustomExceptions.parsing(message: $message, field: $field, originalError: $originalError, stackTrace: $stackTrace)';
}
...
/// @nodoc
abstract mixin class $ParsingExceptionCopyWith<$Res> implements $CustomExceptionsCopyWith<$Res> {
...
class ValidationException implements CustomExceptions {
...
@override
String toString() {
  return 'CustomExceptions.validation(message: $message, field: $field, errors: $errors, stackTrace: $stackTrace)';
}
...
/// @nodoc
abstract mixin class $ValidationExceptionCopyWith<$Res> implements $CustomExceptionsCopyWith<$Res> {
...
class IllegalOperationException implements CustomExceptions {
...
@override
String toString() {
  return 'CustomExceptions.illegalOperation(message: $message, operation: $operation, reason: $reason, stackTrace: $stackTrace)';
}
...
/// @nodoc
abstract mixin class $IllegalOperationExceptionCopyWith<$Res> implements $CustomExceptionsCopyWith<$Res> {
...
class NotFoundException implements CustomExceptions {
  const NotFoundException({required this.message, this.resource, this.identitier, this.stackTrace});
  

@override final  String message;
 final  String? resource;
 final  String? identitier;
@override final  StackTrace? stackTrace;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NotFoundException&&(identical(other.message, message) || other.message == message)&&(identical(other.resource, resource) || other.resource == resource)&&(identical(other.identitier, identitier) || other.identitier == identitier)&&(identical(other.stackTrace, stackTrace) || other.stackTrace == stackTrace));
}


@override
int get hashCode => Object.hash(runtimeType,message,resource,identitier,stackTrace);

@override
String toString() {
  return 'CustomExceptions.notFound(message: $message, resource: $resource, identitier: $identitier, stackTrace: $stackTrace)';
}
...
/// @nodoc
abstract mixin class $NotFoundExceptionCopyWith<$Res> implements $CustomExceptionsCopyWith<$Res> {
...
@override @useResult
$Res call({
 String message, String? resource, String? identitier, StackTrace? stackTrace
});
...
/// Create a copy of CustomExceptions
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? message = null,Object? resource = freezed,Object? identitier = freezed,Object? stackTrace = freezed,}) {
...
as String?,identitier: freezed == identitier ? _self.identitier : identitier // ignore: cast_nullable_to_non_nullable
as String?,stackTrace: freezed == stackTrace ? _self.stackTrace : stackTrace // ignore: cast_nullable_to_non_nullable
as StackTrace?,
  ));
}
...
class UnauthorizedException implements CustomExceptions {
...
@override
String toString() {
  return 'CustomExceptions.unauthorized(message: $message, requiredPermission: $requiredPermission, stackTrace: $stackTrace)';
}
...
/// @nodoc
abstract mixin class $UnauthorizedExceptionCopyWith<$Res> implements $CustomExceptionsCopyWith<$Res> {
...
class UnknownException implements CustomExceptions {
...
@override
String toString() {
  return 'CustomExceptions.unknown(message: $message, originalError: $originalError, stackTrace: $stackTrace)';
}
...
/// @nodoc
abstract mixin class $UnknownExceptionCopyWith<$Res> implements $CustomExceptionsCopyWith<$Res> {
